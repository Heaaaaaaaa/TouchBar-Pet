...
enum PetPixelArt {
    ...
    private static func drawCat(state: PetState, origin: NSPoint, scale: CGFloat) {
        ...
        if state.behaviorMode == .sleep {
            drawPixels([
                ...
                (2, 1, orange), (3, 1, shadow), (4, 1, orange), (5, 1, orange), (6, 1, cream), (7, 1, orange),
                (1, 2, orange), (2, 2, orange), (3, 2, orange), (4, 2, orange), (5, 2, cream), (6, 2, cream), (7, 2, orange),
                (0, 3, white), (1, 3, orange), (2, 3, orange), (3, 3, cream), (4, 3, cream), (5, 3, orange), (6, 3, orange),
        ...
        if state.behaviorMode == .play || state.behaviorMode == .special {
            drawPixels([
                ...
                (0, 1, orange), (1, 1, orange), (2, 1, orange), (3, 1, shadow), (4, 1, orange), (5, 1, orange), (8, 1, orange), (9, 1, orange),
                (1, 2, orange), (2, 2, orange), (3, 2, orange), (4, 2, orange), (5, 2, orange), (6, 2, orange), (7, 2, orange), (8, 2, cream), (9, 2, black),
        ...
        drawPixels([
            ...
            (0, 1, orange), (1, 1, orange), (2, 1, orange), (6, 1, orange), (7, 1, cream), (8, 1, orange), (9, 1, orange),
            (1, 2, orange), (2, 2, orange), (3, 2, orange), (4, 2, orange), (5, 2, orange), (6, 2, orange), (7, 2, cream), (8, 2, black), (9, 2, cream),
    ...
    private static func drawPufferFish(state: PetState, origin: NSPoint, scale: CGFloat) {
        ...
        if puffed {
            drawPixels([
                ...
                (2, 1, gold), (3, 1, gold), (4, 1, gold), (5, 1, gold), (6, 1, gold), (7, 1, gold),
                (1, 2, gold), (2, 2, gold), (3, 2, black), (4, 2, gold), (5, 2, gold), (6, 2, black), (7, 2, gold), (8, 2, gold),
            ...
            drawPixels([
                (1, 1, fin), (2, 0, gold), (3, 0, gold), (4, 0, gold), (5, 1, gold),
                (0, 2, fin), (1, 2, gold), (2, 2, black), (3, 2, gold), (4, 2, belly), (5, 2, gold), (6, 2, fin),
    ...
    private static func drawGhost(state: PetState, origin: NSPoint, scale: CGFloat) {
        let glow = NSColor(calibratedRed: 0.62, green: 0.82, blue: 1.0, alpha: 0.22)
        glow.setFill()
        NSBezierPath(ovalIn: NSRect(x: origin.x - scale, y: origin.y, width: 9 * scale, height: 7 * scale)).fill()
        ...
        drawPixels([
            (3, 0, white), (4, 0, white),
            (2, 1, white), (3, 1, white), (4, 1, white), (5, 1, white),
    ...
    private static func drawDragon(state: PetState, origin: NSPoint, scale: CGFloat) {
        ...
        drawPixels([
            (3, 0, horn), (6, 0, horn),
            (1, topWingY + 1, wing), (2, topWingY, wing), (3, 1, green), (4, 1, green), (5, 1, green), (6, 1, green), (7, 1, darkGreen),
            (0, topWingY + 2, wing), (1, topWingY + 2, wing), (2, 2, green), (3, 2, green), (4, 2, belly), (5, 2, green), (6, 2, black), (7, 2, green), (8, 2, darkGreen),
    ...
    private static func drawPlantBuddy(state: PetState, origin: NSPoint, scale: CGFloat) {
        ...
        var pixels: [(Int, Int, NSColor)] = [
            (2, 4, pot), (3, 4, pot), (4, 4, pot), (5, 4, pot),
            (1, 5, pot), (2, 5, black), (3, 5, pot), (4, 5, pot), (5, 5, black), (6, 5, pot),
        ...
        if droop {
            pixels += [
                ...
                (2, 2, leaf), (3, 2, leafDark), (4, 2, leafDark), (5, 2, leaf),
                (3, 3, leafDark), (4, 3, leafDark),
                (6, 1, water), (7, 0, water)
            ]
        } else if blooming {
            pixels += [
                (3, 0, flower), (4, 0, flower), (2, 1, flower), (3, 1, flower), (4, 1, flower), (5, 1, flower),
                (3, 2, leaf), (4, 2, leaf),
                (2, 3, leaf), (3, 3, leaf), (4, 3, leaf), (5, 3, leaf)
            ]
        } else {
            let sway = state.animationFrame.isMultiple(of: 2) ? 0 : 1
            pixels += [
                (3, 1, leaf), (4, 1, leaf),
                (2 - sway, 2, leaf), (3, 2, leaf), (4, 2, leaf), (5 + sway, 2, leaf),
                (3, 3, leafDark), (4, 3, leafDark)
            ]
        }
    ...
    private static func drawPixels(
        ...
        for (x, y, color) in pixels {
            color.setFill()
            let drawX = direction == .right ? x : maxX - x
            NSRect(
                x: origin.x + CGFloat(drawX) * scale,
